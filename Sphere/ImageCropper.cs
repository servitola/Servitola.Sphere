    ...
    public sealed class ImageCropper : Control, INotifyPropertyChanged
    {
        ...
        private async void UpdatePreviewImage()
        {
            ...
            Size previewImageSize = new Size(
                this.selectedRegion.SelectedRadius * 2 / sourceImageWidthScale,
                this.selectedRegion.SelectedRadius * 2 / sourceImageHeightScale);
            ...
            this.CroppedImage = await CropBitmap.GetCroppedBitmapAsync(
                   this.sourceImageFile,
                   new Point(this.selectedRegion.SelectedCenter.X / sourceImageWidthScale, this.selectedRegion.SelectedCenter.Y / sourceImageHeightScale),
                   previewImageSize,
                   previewImageScale);
        }
